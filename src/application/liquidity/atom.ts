...
import { findLiquidityInfoByTokenMint } from './utils/findLiquidityInfoByTokenMint'
...
//* FAQ: why no setJsonInfos, setSdkParsedInfos and setHydratedInfos? because they are not very necessary, just use zustand`set` and zustand`liquidityAtom.set()` is enough
export const liquidityAtom = createXAtom<LiquidityStore>({
  name: 'liquidity',
  default: () => ({
    /********************** caches (at least includes exhibition's data) **********************/
