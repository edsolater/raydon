...
export function VersionInfoBlock() {
  ...
  return (
    <Tooltip>
      <div className="text-sm mobile:text-2xs m-2 mb-0 leading-relaxed opacity-50 hover:opacity-100 transition font-medium text-[#abc4ff] whitespace-nowrap cursor-default">
      ...
      <Tooltip.Panel>
        <div className="text-xs mobile:text-2xs m-2 leading-relaxed font-medium text-[#abc4ff] whitespace-nowrap cursor-default">
